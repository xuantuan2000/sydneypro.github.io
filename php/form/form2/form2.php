...
<body>
    ...
    $nameErr = $phone_numberErr = $emailErr = $genderErr = $websiteErr = "";
    $name = $phone_number = $email = $gender = $comment = $website = "";
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        if (empty($_POST["phone_number"])) {
            ...
            if (!preg_match("/^[a-zA-Z-' ]*$/", $phone_number)) {
                $phone_numberErr = "Only letters and white space allowed";
            }
        }
